...
export class SettingsComponent implements OnInit {
  ...
  showDialog0() {
    ...
    if(this.gSettings.isDebugMode) this.messageService.add('SettingsComponent.ngOnInit.saveAsync: appComponent.dialog=' + this.appComponent.dialog);
  }
  ...
  async genTempIn(): Promise<void> {
    this.zone.run(()=>{
      this.appComponent.setOfSpinner = {isActivate: true ,title: '創建樣板中', message: '請稍候',value:30};
    });
